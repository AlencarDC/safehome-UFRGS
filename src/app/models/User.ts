...
class User {
  ...
  public validate(): boolean {
    ...
    const isPasswordValid = this.password.length >= minPasswordLength;
    const isUsernameValid = this.username.length >= minUsernameLength;
    const isNameValid = this.name.length >= minNameLength;
